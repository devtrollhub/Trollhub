...
-- 2. NÚT GET KEY MỚI THÊM (Nửa bên phải, cạnh nút Check Key)
local GetKeyBtn = Instance.new("TextButton")
GetKeyBtn.Name = "GetKeyBtn"
GetKeyBtn.Parent = KeyFrame -- (Chung khung với nút Check Key)
GetKeyBtn.Size = UDim2.new(0, 120, 0, 35) -- Kích thước bằng góc nút Check
-- VỊ TRÍ: Đẩy sang phải (pixel 160) để nằm ngay cạnh nút Check Key
GetKeyBtn.Position = UDim2.new(0, 160, 0, 140) 
GetKeyBtn.BackgroundColor3 = Color3.fromRGB(35, 35, 35) -- Màu xám tối cho đỡ chọi màu
GetKeyBtn.Text = "Get Key"
GetKeyBtn.TextColor3 = Color3.fromRGB(255, 200, 0) -- Chữ màu vàng cho nổi bật
...
-- ====================================================================
-- CHỨC NĂNG TỰ ĐỘNG COPY LINK KHI ẤN "GET KEY"
-- ====================================================================
GetKeyBtn.MouseButton1Click:Connect(function()
    -- Thay cái link Linkvertise hoặc link hệ thống Key của mày vào đây nhé
    local keyLink = "https://link4m.net/rAG130" 
    
    -- Hàm hỗ trợ copy vào bộ nhớ tạm của các máy chạy Script (Executor)
    if setclipboard then
        setclipboard(keyLink)
        GetKeyBtn.Text = "Copied Link!" -- Đổi chữ thông báo đã copy thành công
        task.wait(2)
        GetKeyBtn.Text = "Get Key"
    else
        GetKeyBtn.Text = "Error Clipboard"
    end
end)
